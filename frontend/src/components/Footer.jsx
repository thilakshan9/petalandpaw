        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              ...
              {seasonActive && (
                <ScrollLink to="/seasonal" className="text-sm font-light text-[#C4A2B0] hover:text-[#FAF9F6] transition-colors" data-testid="footer-seasonal">{cfg.emoji} Seasonal</ScrollLink>
              )}
